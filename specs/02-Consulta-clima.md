...
La interfaz (UI) debe proporcionar un componente de selección (menú desplegable) con las ubicaciones disponibles (por ahora solo: Tingo María y Huánuco, ambas de Perú).
